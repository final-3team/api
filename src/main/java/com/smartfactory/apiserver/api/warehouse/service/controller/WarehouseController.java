package com.smartfactory.apiserver.api.warehouse.service.controller;
...
public class WarehouseController {
    ...
    @ResponseBody
    public ResponseEntity<?> Test(@Valid WarehouseDTO.TestRequest testRequest) {
        WarehouseDTO.TestResponse response = warehouseService.Test(testRequest);
